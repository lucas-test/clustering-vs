...
def solve(G, nse_file_path, original_assignation):
    solver = OClustR()
    results_OClustR = solver.cluster_graph(G)
    clusters = results_OClustR[0]
    assignation_OClustR = assignation_from_clusters(clusters)
    return assignation_OClustR, clusters